...
@section('title', $pageTitle . ' — LITUS Connect')
...
@section('content')
    ...
    <div class="bg-white border-b border-border">
        <div class="site-container py-3 flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span class="font-bold text-[#011848]">{{ $pageTitle }}</span>
        </div>
    </div>

    <div class="site-container py-6 pb-10" data-shop-page data-shop-mode="category">
        <div class="flex items-center justify-between mb-5 md:hidden">
            <h1 class="text-xl font-extrabold text-[#011848]">{{ $pageTitle }}</h1>
        ...
        <div class="flex gap-6 lg:gap-8">
            <aside class="hidden md:block w-[260px] lg:w-[280px] flex-shrink-0 self-start sticky top-28">
                @include('components.category_page.category-filters', [
            ...
            <div class="flex-1 min-w-0">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
                    <div>
                        <h1 class="hidden md:block text-2xl font-extrabold text-[#011848]">{{ $pageTitle }}</h1>
                ...
                <div data-shop-empty class="hidden flex-col items-center justify-center py-24 bg-white rounded-xl border border-border text-center">
                    <div class="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center mb-4">
                        <x-lucide :name="$emptyIcon" :size="28" class="text-gray-300" />
                    </div>
                    <h3 class="font-bold text-lg text-foreground mb-2">{{ $emptyTitle }}</h3>
